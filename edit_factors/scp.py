...
for cp_pair in scp_pairs:
    ...
    # Save plot
    save_dir = "edit_factors/scp/plots/eigenvalues"
    ...
    # --- Save CSVs ---
    data_dir = f"edit_factors/scp/data/{cp_pair}"
    ...
    focus_dir = "edit_factors/scp/plots/small"
    ...
    counts_dir = "edit_factors/scp/plots/counts"
    ...
    for ax, (label, eigvals, eigvecs, color) in zip(axes_u, datasets):
        ...
        ax.plot(
            ...
            label="2nd Smallest Eigenvector"
        )
    ...
    # Save plot
    save_dir = "edit_factors/scp/plots/eigenvectors"
    os.makedirs(save_dir, exist_ok=True)
